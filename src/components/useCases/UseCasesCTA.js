        ...
        <div className="relative grid items-center gap-10 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-gray-300 sm:text-lg">
              Let our experts create a powerful digital solution that helps your
          ...
          >
            <motion.div
              ...
              className="flex h-64 w-64 items-center justify-center rounded-full bg-lime-300 sm:h-72 sm:w-72"
            >
              <div className="flex h-44 w-44 flex-col items-center justify-center rounded-full bg-black text-center">
                ...
                <p className="mt-4 text-lg font-bold text-white">Grow Faster</p>

                <p className="text-sm text-gray-400">With Digital Solutions</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
