...
//           Contact us if you need more information about our cookie practices.
//         </p>
...
import { HiArrowRight, HiCircleStack } from "react-icons/hi2";
        ...
        >
          <div className="rounded-3xl bg-white/95 px-6 py-10 sm:px-10">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600">
              <HiCircleStack className="text-3xl text-white" />
            </div>
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-gray-600 sm:text-lg">
              If you have any questions about our cookie practices or privacy
              preferences, feel free to contact our team.
            </p>
